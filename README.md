...
```javascript
import y0 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-bessely0@v0.3.1-esm/index.mjs';
```
...
import bessely0 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-bessely0@v0.3.1-esm/index.mjs';
