...
var y0 = tryRequire( resolve( __dirname, './../lib/native.js' ) );
var opts = {
	'skip': ( y0 instanceof Error )
};
...
tape( 'main export is a function', opts, function test( t ) {
	...
	t.strictEqual( typeof y0, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns `-Infintiy` if provided `0.0`', opts, function test( t ) {
	var v = y0( 0.0 );
